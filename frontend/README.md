# Day 4
1. In react, Authication is added to the to the main.jsx so that Auth can accessed whatever inside is present. 

2. After Writing the code of Dashboard, I will need to setup routing for the dashboard
